  ...
  RESPONSES: Object.freeze({
    zh: Object.freeze({
      ...
      VALIDATION: Object.freeze({
        ...
        ROOM_REQUIRED: '請輸入房號',
        ROOM_FORMAT: '房號格式錯誤（需為 H、I、G、FA~FF 開頭，後接 1–4 位數字，可加 - 連接號碼，例如：H0111、G408-1）',
        BED_FORMAT: '床號格式錯誤（僅限 1 位數字，例如：1）',
    ...
    en: Object.freeze({
      ...
      VALIDATION: Object.freeze({
        ...
        ROOM_FORMAT: 'Invalid Room Number (Must start with H, I, G, or FA–FF, followed by 1–4 digits, optionally with a dash, e.g. H0111 or G408-1)',
        BED_FORMAT: 'Invalid Bed Number (1 digit only, e.g. 1)',
