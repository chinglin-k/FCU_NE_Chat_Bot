...
const I18N = (() => {
  ...
  const STRINGS = {
    zh: {
      ...
      'form.repairTime.24h': '請依24小時制填寫時間',
      ...
      'form.repairTime.sep': '─',
      'form.repairTime.fillStart': '開始',
      'form.repairTime.fillEnd': '結束',
      'form.repairTime.fillNow': '⏰ 填入現在時間',
      'form.repairTime.fillStart.aria': '填入現在時間為可維修開始時間',
      'form.repairTime.fillEnd.aria': '填入現在時間為可維修結束時間',
      'form.repairTime.hint':
        '⏰ 可維修時間請填寫 <strong>18:00–21:00</strong> 之間（本人需在場）。新生入住期間 12:00–17:00 收到後會盡速前往協助。',
      'form.description.label': '問題描述',
      'form.description.scopeNote': '僅處理網路範圍內業務',
    ...
    en: {
      ...
      'form.room.placeholder': 'e.g. H0111, G4081, G408-1',
      ...
      'form.repairTime.24h': 'Use 24-hour format',
      ...
      'form.repairTime.fillStart': 'Start',
      'form.repairTime.fillEnd': 'End',
      'form.repairTime.fillNow': '⏰ Fill Current Time',
      'form.repairTime.fillStart.aria': 'Fill current time as available start time',
      'form.repairTime.fillEnd.aria': 'Fill current time as available end time',
      'form.repairTime.hint':
      ...
      'form.description.scopeNote': 'Network-related issues only',
      'form.description.placeholder':
